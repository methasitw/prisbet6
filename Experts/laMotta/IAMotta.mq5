...
LaMotta LaMottaEURUSD; // class instance
//------------------------------------------------------------------	OnInit
int OnInit()
  {
   LaMottaEURUSD.Init(Symbol(),Period()); // initialize expert
...
void OnTick()
  {
   LaMottaEURUSD.Main(); // process incoming tick
  }
//+------------------------------------------------------------------+
