...
//    HITOS 2011
      // *  PRIS  **                                    /*implementar                                              */             44 /*find semana WTF*/
      // WFO   USDEUR   USDGBP ... ETC                  /*normalizar para el resto de divisas y hacerlo multidivisa*/             45 /*find semana Ernesto*/
      // WFO   USDEUR   USDGBP ... ETC                  /*normalizar para el resto de divisas y hacerlo multidivisa*/             46 /*find semana for me*/
      


//+------------------------------------------------------------------+
//|   Entrada deal inicial       BB 90 2.33  
//    Entrada deal pyr           BB 25 1.8   ** Black Monday.
//    Entrada deal Fib           BB 90 2.33  ** Bad Times.
//    Salida deal Black monday   -BB 25 Sell/Buy 50% && Fase Black Monday.
//    Salida deal Butterfly      -BB 90 Sell/Buy && Fase Butterfly.

//    Volumen inicial :   se calcula el numero de puntos en relación al 0.8% del valor nominal de la divisa y al riesgo expuesto x entrada en este caso 90€
//    Volumen de piramidación Black Monday en parte tiene que ser en relación al volumen de la cuenta y al numero de orden.
//    Volumen de piramidación ButterFly tiene en cuenta la recogida de beneficios anterior



//       Parche que esta basado en eliot fibonnaci y demás pandilla de colgados.
//    Se distinguen tres fases diferentes en el sistema:
//         Black Monday :     Gran caida inicial anterior al retroceso de fibonacci
//                            En esta fase puede darse la circunstacia que toque la -BB 25 o la -BB 90 en cuyo caso habría diferente recogida de beneficios.
//         bad times:         El precio empieza a cambiar de dirección para compensar la anterior sobreventa/sobrecompra de la primera fase.
//                            En esta fase puede suceder que el precio llega a contradecir la tendnencia inicial hasta niveles cercanos a fibonnacci este sería el momento de invertir el 80% de los beneficios recogidos anteriormente.
//         butterfly:         El precio consolida la tendencia inicial y la posicion se cierra en caso que llege a -BB 90 o si el TP es alcanzado.

//          peakBlack()       if -BB 25 Sell/Buy 50% 
//          peakFibonacci()   if +BB 90 Sell/Buy *o señal similar*
//                     Volumen = f(Vol(acoount/2 ))
//                      
//             -- estas tres zonas pueden delimitarse a partir del punto inicial y aplicando angulos en relacion a phi//          
//+------------------------------------------------------------------+
...
#include <utilsPris12\RiskManagement.mqh>
