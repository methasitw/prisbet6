...
//---- 8 buffers are used for calculation and drawing the indicator
...
//---- shifting the start of drawing the indicator 1
   ...
   // para utilizarlo desde un EA
   SetIndexBuffer(5,MA,INDICATOR_DATA);
   SetIndexBuffer(6,MACDM,INDICATOR_DATA);
   SetIndexBuffer(7,MACDS,INDICATOR_DATA);
