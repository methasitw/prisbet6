...
public:
   ...
   void              SetOrbite(const CSphere *sun,const double fi_x,const double fi_y,const double fi_z,const double d_fi_orb);
   void              Recalculate();
  };
//+------------------------------------------------------------------+
//| Constructor                                                      |
...
//| Setting                                                          |
//+------------------------------------------------------------------+
void CSphere::SetOrbite(const CSphere *sun,const double fi_x,const double fi_y,const double fi_z,const double d_fi_orb)
  {
   m_orbite_center=sun;
   m_orbite_fi_X=fi_x;
   m_orbite_fi_Y=fi_y;
